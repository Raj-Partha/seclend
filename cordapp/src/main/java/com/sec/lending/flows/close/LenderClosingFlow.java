...
@InitiatedBy(BorrowerInitiatedClosingFlow.class)
public class LenderClosingFlow extends FlowLogic<SignedTransaction> {
    ...
    public LenderClosingFlow(FlowSession otherPartySeesion) {
