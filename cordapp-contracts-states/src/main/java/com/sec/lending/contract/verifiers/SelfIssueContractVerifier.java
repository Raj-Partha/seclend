...
public class SelfIssueContractVerifier extends ContractVerifier {

    public SelfIssueContractVerifier(LedgerTransaction tx) {
        super(tx);
    }
    ...
    protected void verify() {
        requireThat(require -> {
            ...
            require.using("No input states should be there.", getTx().getInputs().size() == 0);
